...
-- 插入 User 数据
INSERT INTO User (student_number, pwd, name, sex, BirthDate) VALUES
('2021001', 'userpwd1', '张三', '男', '2000-01-01'),
('2021002', 'userpwd2', '李四', '女', '1999-02-02'),
('2021003', 'userpwd3', '王五', '男', '2001-03-03');
...
-- 插入 Food 数据
INSERT INTO Food (name, classificationId, picture, score, price, sales_volume, description, nutrition, ingredient, allergy, MerchantId) VALUES
('宫保鸡丁', 1, 'gongbao.jpg', 4.5, 38.00, 120, '经典川菜，口感鲜香', '高蛋白质', '鸡肉, 花生', '花生过敏者慎食', 1),
('麻婆豆腐', 1, 'mapo.jpg', 4.2, 28.00, 150, '麻辣鲜香', '植物蛋白', '豆腐, 辣椒', '无', 1),
('水煮鱼', 1, 'shuizhu.jpg', 4.8, 58.00, 100, '香辣可口', '高蛋白质', '鱼, 辣椒', '鱼类过敏者慎食', 1),
('清蒸鲈鱼', 2, 'luyu.jpg', 4.8, 68.00, 80, '清淡健康，肉质鲜美', '高蛋白质', '鲈鱼', '鱼类过敏者慎食', 2),
('广式烧鹅', 2, 'shaoge.jpg', 4.6, 88.00, 70, '外皮酥脆，肉质鲜嫩', '高蛋白质', '鹅肉', '无', 2),
('糖醋排骨', 3, 'tangcu.jpg', 4.5, 48.00, 90, '酸甜可口', '高蛋白质', '猪排骨', '无', 3),
('红烧狮子头', 3, 'shizitou.jpg', 4.7, 38.00, 85, '软糯鲜香', '高蛋白质', '猪肉', '无', 3),
('剁椒鱼头', 5, 'duojiao.jpg', 4.7, 68.00, 95, '鲜辣入味', '高蛋白质', '鱼头', '鱼类过敏者慎食', 3),
('东坡肉', 6, 'dongpo.jpg', 4.8, 58.00, 110, '肥而不腻', '高蛋白质', '猪肉', '无', 3),
